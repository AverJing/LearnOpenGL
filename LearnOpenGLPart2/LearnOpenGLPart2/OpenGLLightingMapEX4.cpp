...
*
*@author：Aver Jing
*@description：Also add something they call an emission map which is a texture that stores emission values per fragment. 
*@date：April 10, 2018
*
*/
...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("lightingMapEX4.vs", "lightingMapEX4.fs");
