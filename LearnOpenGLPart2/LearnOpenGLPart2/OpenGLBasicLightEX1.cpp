...
*
*@author£ºAver Jing
*@description£ºtarget 1:Try to move the light source around the scene over time  using either sin or cos.  
*Target 2: Play around with different ambient, diffuse and specular strengths and see how they impact the result. 
...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("color.vs", "colorEX.fs");
