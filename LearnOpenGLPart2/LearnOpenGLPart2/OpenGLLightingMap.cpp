...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("lightingMap.vs", "lightingMap.fs");
	...
	unsigned int diffuseMap2 = loadTexture("lighting_maps_specular_color.png");
...
unsigned int loadTexture(char const * path)
{
	...
	{
		GLenum format;
		if (nrComponents == 1)// single color
			format = GL_RED;
