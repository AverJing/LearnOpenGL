...
TextRender::TextRender(GLuint width, GLuint height)
{
	...
	this->TextShader = ResourceManager::LoadShader("shaders/text.vs", 
		"shaders/text.fs", nullptr, "text");
	this->TextShader.use();
	this->TextShader.setMat4("projection", glm::ortho(0.f, static_cast<GLfloat>(width),
...
void TextRender::Load(const std::string & font, GLuint fontSize)
{
...
void TextRender::RenderText(const std::string &text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color)
{
